...
    // CORRIGIDO: Agora usando a._createdAt/a._updatedAt que são os campos do Sanity.
    const sortedCourses = useMemo(() => {
        if (!courses || courses.length === 0) return [];

        // Cria uma cópia e ordena
        return [...courses].sort((a, b) => {
            // Prioriza _createdAt, depois _updatedAt, e por último _id como fallback
            const dateA = a._createdAt || a._updatedAt || a._id; 
            const dateB = b._createdAt || b._updatedAt || b._id;
            
